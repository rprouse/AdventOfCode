...
public class Day15Tests : TestBase
{
    ...
    public static IEnumerable TestDataOne()
    {
        ...
        yield return new TestCaseData(PuzzleFile(DAY), 18965440);
    }

    public static IEnumerable TestDataTwo()
    {
        yield return new TestCaseData(TestFile(DAY), 57600000);
        yield return new TestCaseData(PuzzleFile(DAY), 15862900);
    }
}
